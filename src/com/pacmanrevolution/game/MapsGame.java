...
public class MapsGame {
	...
	private int composition[][] = {
			...
			{15, 6,27, 6,29,20,18,18,30, 8,26,18,18,18,18,18,18,18,18,23, 6,15},
			{15, 6,17, 6, 6,17, 6, 6, 6, 6,17, 6, 6, 6, 6, 6, 6, 6,10,17, 6,15},
			{15, 6,25,23, 6,17, 6,29,18,18,24, 7,29,18,18,18,18,23, 6,17, 6,15},
			{15, 6,26,24, 6,17, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6,17, 6,17, 6,15},
			{15, 6,17, 6, 6,17,26,18,18,18,18,18,18,18,18,30, 6,28, 6,28, 6,15},
			{15, 6,17, 6,29,19,24, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6,15},
			{15, 6,17, 6, 6, 6, 6, 6,26,30, 0, 0,29,23, 6,26,18,18,18,30, 6,15},
			{15, 6,17,12,29,18,23, 6,17, 0, 0, 0, 0,17, 6,17, 6, 6, 6,14, 6,15},
			{15, 6,17, 6, 6, 7,17, 6,25,18,18,18,18,24, 6,28, 6,27, 6,27, 6,15},
			{15, 6,25,18,23, 6,17, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6,17, 6,17, 6,15},
			{15, 6, 6, 6,17, 6,25,18,18,18,30,11,29,18,18,18,18,24, 6,28, 6,15},
			{15, 6,27, 6,17, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6,15},
			{15, 6,17, 6,25,30, 6,29,18,18,18,18,18,18,18,18,18,18,18,30, 6,15},
			{15, 6,17, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6,13, 6,15},
			{15, 6,25,18,18,18,18,30, 9,29,18,18,18,18,18,18,18,18,18,30, 6,15},
			{15, 7, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 7,15},
			{18,18,18,18,18,18,18,18,18,18,18,18,18,18,18,18,18,18,18,18,18,18},
		};
	...
	public int getComposition(int x , int y) {
		/*if(x > 20) {return composition[y][18];}
		
		else if(x <0) {return composition[y][18];}
		
		else if(y >18) {return composition[17][x];}
		
		else if(y <0) {return composition[0][x];}
		
		else if(y <0 && x <0) {return composition[0][0];}
		
		else if(y >18 && x <0) {return composition[17][0];}
		
		else if(y >18 && x >19) {return composition[17][18];}
		
		else if(y <0 && x >19) {return composition[0][18];}
		
		else {return composition[y][x]; }
		*/
